  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Breeder Management</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Beeder</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <?php 
                  ...
                  <tr>
                     ...
                     <span class="badge badge-success"><?php echo $row->contactno; ?></span></td>
                      ...
                      <td>
                       <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/User/addtmessage?t_id=<?php echo $row->b_id; ?>"><i class="fas fa-reply"></i> Sent Message</a>          </td> 
                  </tr>
                  <?php
                  $i++;
				  }
