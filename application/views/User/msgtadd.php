...
<div class="card card-default">
  ...
  ?>
           <div class="error_msg" style="color:#FF0000"> <?php echo validation_errors();?></div> 
                                    	...
                                    	<form method="post" action="<?php echo site_url('User/addtmessage'); ?>" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Previous Msg</label>
                  <?php include "include/conn.php";// $loc_id=$row->loc_id;
					  $qry = "select * from `message` WHERE u_id='$u_id'";
                      $res = mysql_query($qry)or trigger_error(mysql_error());
					  $rw=mysql_fetch_array($res);
					  echo "</br>	";				  echo $rw['reply']; 
					  ?></td><?php ?>
                <!--<input type="tex" name="name" id="inputName" class="form-control" value="<?php echo $row->name; ?>" readonly="readonly">-->
                </div>
              </div>
              ...
              <div class="col-md-6">
                ...
                <input type="hidden" name="t_id" id="inputName" class="form-control" value="<?php echo $row->b_id; ?>">
          ...
          <div class="card-footer">
            <div class="row">
        <div class="col-12">
          <a href="<?php echo base_url(); ?>index.php/User/trainer" class="btn btn-secondary">Cancel</a>
