  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Boarding Management</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <?php 
                  ...
                  <tr>
                     ...
                     <span class="badge badge-success"><?php echo $row->contactno; ?></span></td>
                      ...
                      <td>
                        <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/User/addbdmessage?bd_id=<?php echo $row->bd_id; ?>"><i class="fas fa-reply"></i> Sent Message</a> </td> 
                  </tr>
                  <?php
                  $i++;
				  }
