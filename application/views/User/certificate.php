        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add c</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card card-default">
  ...
  ?>
              ...
              <div class="card" >
                ...
                <h2 style="color:#0066ff"><center>CERTIFICATE OF GOOD HEALTH</center></h2>
                  ...
                  <h1 style="color:#0066ff"><center><?php echo $row->pet_name; ?></center></h1>
                   ...
                   <center><p>Has undergone a medical checkup and is found to be physically fit</p></center>
          ...
          <div class="card-footer">
            <div class="row">
        <div class="col-12">
          <a href="<?php echo base_url(); ?>index.php/user/purhis" class="btn btn-secondary">Cancel</a>
