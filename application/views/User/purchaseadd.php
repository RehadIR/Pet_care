        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Purchase pet</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card card-default">
  ...
  ?>
           <div class="error_msg" style="color:#FF0000"> <?php echo validation_errors();?></div> 
                                    	...
                                    	<form method="post" action="<?php echo site_url('User/purchase'); ?>" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Quantity</label>
                <input type="tex" name="quantity" id="inputName" class="form-control" value="">
				<input type="hidden" name="price" id="inputName" class="form-control" value="<?php echo $row->price;?>">
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <textarea class="form-control" name="address" placeholder="Enter Correct Address Here"></textarea>
				 
                <input type="hidden" name="p_id" id="inputName" class="form-control" value="<?php echo $row->p_id; ?>">
                <input type="hidden" name="b_id" id="inputName" class="form-control" value="<?php echo $row->b_id; ?>">
