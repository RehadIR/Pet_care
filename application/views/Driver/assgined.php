              ...
              <?php 
                  ...
                  <tr>
                    ...
                    <td>
					   ...
					   elseif($stat==1)
					   {?>
                       <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>index.php/Driver/unapprovereq?ass_id=<?php echo $row->ass_id; ?>"><i class="fas fa-thumbs-up"></i></a> <a class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>index.php/Driver/addlocation?ass_id=<?php echo $row->ass_id; ?>&& req_id= <?php echo $row->req_id; ?>">Add Location</a>
                        <?php }
					   else
					   {?>
                       <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/Driver/approvereq?ass_id=<?php echo $row->ass_id;?> && req_id= <?php echo $row->req_id; ?>&& del_fee= <?php echo $row->req_id; ?>"><i class="fas fa-thumbs-down"></i></a> 
                       <?php }
					   ?>
