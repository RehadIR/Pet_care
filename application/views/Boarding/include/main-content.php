      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            mysql_select_db("garbage", $con) or die (mysql_error());
            ?>
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php $qry="select * from `bin`"; 
				$res = mysql_query($qry); 
