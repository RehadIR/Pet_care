 <?php include 'include/cheader.php';?>
    ...
    <p align="center" style="color:#006600;"><b><?php echo @$success; ?></b></p>
                        <div class="icon-box-1 d-flex">
                            <div class="icon-font">
                            ...
                            <div class="text">
                                ...
                                <p> <form method="post" id="regForm">
                                    ...
                                    <p> <input type="text" name="name" value="" placeholder="Name" class="form-control"> </p>
                                    <p> <input type="radio" name="gender" value="male" >Male <input type="radio" name="gender" value="female">Female</p>
                                    <p> <input type="text" name="email" value="" placeholder="Email" class="form-control"> </p>
                                    <p> <input type="text" name="mobile" value="" placeholder="Mobile" class="form-control"> </p>
                                    <p><textarea name="address" cols="" rows="" class="form-control"></textarea></p>
                                    ...
                                    <p><input type="submit" name="register" value="Register Here" class="btn btn-success btn-block btn-lg"></p>
                                    </form> 
                               </p>
                             <i class="icofont-simple-left"></i> <a href="<?php echo base_url(); ?>index.php/login" class="read-more-arrow"> Back to Login <span> </span> </a>
                            </div>
                        </div>
                    </div>
                    <!-- Icon Boxes One Style -->
