      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="<?php echo base_url(); ?>index.php/Vet" class="nav-link active">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="nav-item has-treeview menu-open">
            <a href="<?php echo base_url(); ?>index.php/Vet/certificate" class="nav-link">
            ...
            <li class="nav-item has-treeview menu-open">
            <a href="<?php echo base_url(); ?>index.php/Vet/bmessage" class="nav-link">
              <i class="nav-icon fas fa-envelope"></i>
              <p>Breeder Message</p>
            </a>
          </li>
			<li class="nav-item has-treeview menu-open">
            <a href="<?php echo base_url(); ?>index.php/Vet/message" class="nav-link">
              <i class="nav-icon fas fa-envelope"></i>
