  ...
  ?>
           <div class="error_msg" style="color:#FF0000"> <?php echo validation_errors();?></div> 
            	...
            	<form method="post" action="<?php //echo site_url('Breeder/addvideo'); ?>" enctype="multipart/form-data">
            		<div class="row">
              			<div class="col-md-6">
                			...
                			<div class="form-group">
                                ...
                                <input type="text" name="petss" id="inputName" class="form-control" value="<?php echo $row2->pet_name; ?>"disabled>
                               
                                <input type="file" name="pvideo" class="form-control"  value="<?php echo $row2->p_video; ?>" title="Upload Pet video" placeholder="Upload Pet video">
                                
                                <!--<video width="300" height="300" controls="controls">
                                <source src="<?php //echo base_url().'assets_admin/images/'.$row2->p_video ;?>" type="video/mp4" />
                                </video>-->
            <!-- <p><input name="vupload" value="Upload Video" type="submit" /></p></div>-->
                  			</div>
              			</div>
              <!-- /.col -->
