...
<div class="card card-default">
          ...
          <div class="card-body">
           ...
           <?php foreach($data as $row) $b_id = $row->b_id;?> <?php $this->session->set_userdata(array('b_id'=>$b_id));  ?>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="password" id="inputName" class="form-control" value="<?php echo $row->password; ?>" readonly="readonly">
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
