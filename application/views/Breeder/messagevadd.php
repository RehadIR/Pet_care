  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Communication with Vet</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Add Message to Vet</h3>
  ...
  ?>
           <div class="error_msg" style="color:#FF0000"> <?php echo validation_errors();?></div> 
                                    	...
                                    	<form method="post" action="<?php echo site_url('Breeder/addvmessage'); ?>" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="hidden" name="v_id" id="inputName" class="form-control" value="<?php echo $row->u_id; ?>">
                </div>
