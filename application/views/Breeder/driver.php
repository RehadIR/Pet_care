          ...
          <table class="table table-striped projects">
              ...
              <?php 
                ...
                <!-- 
					   ...
					   if($stat==1)
					   {?>
                       <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>index.php/Breeder/unapprovedrdata?d_id=<?php echo $row->d_id; ?>"><i class="fas fa-thumbs-up"></i></a>
                        <?php }
					   else
					   {?>
                       <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/Breeder/approvedrdata?d_id=<?php echo $row->d_id; ?>"><i class="fas fa-thumbs-down"></i></a> -->
                       <?php }
					   ?>
                         <!-- <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/bin/deletedata?u_id=<?php echo $row->u_id; ?>"><i class="fas fa-trash"></i></a>-->                      
                  </tr>
                  <?php
                  $i++;
				  }
