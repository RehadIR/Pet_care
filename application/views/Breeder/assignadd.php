        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Assign Delivery</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card card-default">
  ...
  ?>
           <div class="error_msg" style="color:#FF0000"> <?php echo validation_errors();?></div> 
                                    	...
                                    	<form method="post" action="<?php echo site_url('Breeder/addassign'); ?>" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
				 ...
				 <option value="">-- Select Driver --</option>
                   <?php foreach($data1 as $row)
							{ ?>
				<option value="<?php echo $row->d_id; ?>"><?php echo $row->name;echo "-->";echo $row->place; ?></option>
                    <?php } ?>
				</select>
