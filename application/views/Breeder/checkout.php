...
<div class="card card-default">
		...
		<?php $b_id = $this->session->userdata('b_id');
		if(isset($b_id)){
		
			$sql = "SELECT * FROM breeder WHERE b_id='$b_id'";
		...
		?>
			...
			<div class="col-md-12">
				...
				<form id="checkout_form" action="<?php echo site_url('Breeder/checkout'); ?>" method="POST" class="was-validated">
					...
					<div class="col-md-12">
                        ...
                        <label for="cname">Total Amout</label>
						<input type="text" id="amt" name="amt" class="form-control" value="<?php echo $_GET['total'];?>" readonly>
