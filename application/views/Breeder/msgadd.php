...
<div class="card card-default">
  ...
  ?>
           <div class="error_msg" style="color:#FF0000"> <?php echo validation_errors();?></div> 
                                    	...
                                    	<form method="post" action="<?php echo site_url('Breeder/addmessage'); ?>" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
          ...
          <div class="card-footer">
            <div class="row">
        <div class="col-12">
          <a href="<?php echo base_url(); ?>index.php/Breeder/vet" class="btn btn-secondary">Cancel</a>
