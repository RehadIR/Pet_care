...
<div class="card card-default">
  ...
  ?>
           <div class="error_msg" style="color:#FF0000"> <?php echo validation_errors();?></div> 
                                    	...
                                    	<form method="post" action="<?php echo site_url('Breeder/addreply'); ?>" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="hidden" name="req_id" id="inputName" class="form-control" value="<?php echo $row->req_id; ?>">
                </div>
