  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">VET-Doctor</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">VET-Doctor</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Edit VET-Doctor Details</h3>
		  ...
		  ?>
           <div class="error_msg" style="color:#FF0000"> <?php echo validation_errors();?></div> 
                                    	...
                                    	<form method="post" action="<?php echo site_url('admin/editvet'); ?>">
            <div class="row">
              <div class="col-md-6">
          ...
          <div class="card-footer">
            <div class="row">
                <div class="col-12">
                  <a href="<?php echo base_url(); ?>index.php/admin/vet" class="btn btn-secondary">Cancel</a>
