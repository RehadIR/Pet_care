...
<div class="card card-default">
          ...
          <div class="card-body">
           ...
           <div class="error_msg" style="color:#FF0000"> <?php echo validation_errors();?></div> 
                                    	...
                                    	<form method="post" action="<?php echo site_url('Admin/adddriver'); ?>" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                 ...
                 <input type="text" name="contactno" id="inputName" class="form-control" placeholder="Driver's Contact No">
                  ...
                  <label>place</label>
                 <input type="text" name="place" id="inputName" class="form-control" placeholder="place">
                </div>
                <div class="form-group">
