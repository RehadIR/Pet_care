  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Registered Agency</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <?php 
                  ...
                  <tr>
                      ...
                      <td>
					   ...
					   if($stat==1)
					   {?>
                       <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>index.php/admin/unapprove?ag_id=<?php echo $row->ag_id; ?>"><i class="fas fa-thumbs-up"></i></a>
                        <?php }
					   else
					   {?>
                       <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/admin/approve?ag_id=<?php echo $row->ag_id; ?>"><i class="fas fa-thumbs-down"></i></a> 
                       <?php }
					   ?>
