                  ...
                  <tr>
                     ...
                     <span class="badge badge-success"><?php echo $row->contactno; ?></span></td>
                      ...
                      <td>
					   ...
					   if($stat==1)
					   {?>
                       <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>index.php/admin/unapprovedata?u_id=<?php echo $row->u_id; ?>"><i class="fas fa-thumbs-up"></i></a>
                        <?php }
					   else
					   {?>
                       <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/admin/approvedata?u_id=<?php echo $row->u_id; ?>"><i class="fas fa-thumbs-down"></i></a> 
                       <?php }
					   ?>
