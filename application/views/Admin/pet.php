              ...
              <?php 
                  ...
                  <tr>
                      ...
                      <td>
					   ...
					   if($stat==1)
					   {?>
                       <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>index.php/admin/unapprovepet?p_id=<?php echo $row->p_id; ?>" onClick="return doconfirm1()"><i class="fas fa-thumbs-up"></i></a>
                        <?php }
					   else
					   {?>
                       <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/admin/approvepet?p_id=<?php echo $row->p_id; ?>" onClick="return doconfirm2()"><i class="fas fa-thumbs-down"></i></a> 
                       <?php }
					   ?>
