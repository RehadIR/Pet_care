                  ...
                  <tr>
                     ...
                     <span class="badge badge-success"><?php echo $row->contactno; ?></span></td>
                      ...
                      <td>
					   ...
					   if($stat==1)
					   {?>
                       <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>index.php/admin/unapprovebddata?bd_id=<?php echo $row->bd_id; ?>"><i class="fas fa-thumbs-up"></i></a>
                        <?php }
					   else
					   {?>
                       <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/admin/approvebddata?bd_id=<?php echo $row->bd_id; ?>"><i class="fas fa-thumbs-down"></i></a> 
                       <?php }
					   ?>
                         <!-- <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>index.php/bin/deletedata?bd_id=<?php echo $row->bd_id; ?>"><i class="fas fa-trash"></i></a>-->                      </td> 
                  </tr>
                  <?php
                  $i++;
				  }
