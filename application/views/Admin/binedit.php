...
<div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Edit Bin Details</h3>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Location</label>
                   <input type="text" name="loc_id" id="inputName" class="form-control" readonly="readonly" value="<?php $loc_id=$row->loc_id; $qry = "select * from `location` WHERE loc_id='$loc_id'"; $res = mysql_query($qry); $rw=mysql_fetch_array($res); echo $rw['location']; ?>">
                ...
                <textarea name="nearest_of" cols="" rows="" class="form-control"><?php echo $row->nearest_of; ?></textarea>
               </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="text" name="capacity" id="inputName" class="form-control" value="5" readonly="readonly" value="5">
                </div>
              <!-- <div class="form-group">
