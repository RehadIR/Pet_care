        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              <thead>
                  <tr>
                      <th style="width: 1%">#</th>
                      <th style="width: 35%">Training Details</th>
              ...
              <?php 
                  ...
                  <tr>
                      ...
                      <td><!--<a href="<?php echo base_url(); ?>index.php/Trainer/addreply?mes_id=<?php echo $row->mes_id; ?>"><input type="submit" value="Add Reply" class="btn btn-success"></a>--></td> 
                  </tr>
                  <?php
                  $i++;
				  }
